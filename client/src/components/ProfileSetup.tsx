...
// Simplified profile setup schema
...
export default function ProfileSetupFixed({ onComplete }: ProfileSetupProps) {
 ...
 // Supabase Edge Function calls with better error handling
 const callEdgeFunction = async (functionName: string, data: any) => {
   ...
   if (!response.ok) {
     console.error(`Edge function ${functionName} failed:`, result)
 ...
 const handleCompleteProfile = async () => {
   try {
     ...
     const result = await callEdgeFunction("complete-profile", {})
                     ...
                     <div className="w-full h-32 bg-black/50 rounded-lg overflow-hidden border border-pink-500/30">
                       <img
                         ...
                         onError={(e) => {
                           ...
                           e.currentTarget.src =
                             "data:image/svgxml;base64,"
                         }}
       ...
       <div className="w-full max-w-2xl mx-auto p-8 bg-black/70 rounded-2xl border-2 border-pink-500/60 shadow-lg shadow-pink-500/20 backdrop-blur-sm">
         ...
         <div className="mt-8 pt-6 border-t border-pink-500/30 text-center">
           ...
           <p className="text-xs text-white/70">
             Premium lifestyle community for 18verified members only. Your privacy and discretion are our top
             priorities.
           </p>
         </div>
       </div>
